...
export const announcementPriority = pgEnum("announcement_priority", [
  "info",
  "warning",
  "critical",
]);
...
export const compliancePriority = pgEnum("compliance_priority", [
  "low",
  "medium",
  "high",
  "urgent",
...
export const importEntityType = pgEnum("import_entity_type", [
  "clients",
  "tasks",
  "services",
]);
...
export const onboardingPriority = pgEnum("onboarding_priority", [
  "low",
  "medium",
  "high",
]);
...
export const pricingRuleType = pgEnum("pricing_rule_type", [
  "turnover_band",
  "transaction_band",
  "employee_band",
  "per_unit",
...
export const serviceComponentCategory = pgEnum("service_component_category", [
  "compliance",
  "vat",
  "bookkeeping",
  "payroll",
...
export const transactionDataSource = pgEnum("transaction_data_source", [
  "xero",
  "manual",
  "estimated",
]);
...
export const activityLogs = pgTable(
  ...
  (table) => [
    index("idx_activity_created").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("idx_activity_entity").using(
      "btree",
      table.entityType.asc().nullsLast().op("text_ops"),
      table.entityId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_activity_tenant_entity").using(
      "btree",
...
export const amlChecks = pgTable(
  ...
  (table) => [
    index("idx_aml_check_check_id").using(
      "btree",
      table.checkId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_aml_check_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_aml_check_session").using(
      "btree",
      table.onboardingSessionId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_aml_check_status").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("idx_aml_check_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const announcements = pgTable(
  ...
  (table) => [
    index("announcements_ends_at_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.endsAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("announcements_pin_created_idx").using(
      "btree",
    ...
    index("announcements_starts_at_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("timestamp_ops"),
      table.startsAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("announcements_tenant_active_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("bool_ops"),
...
export const calendarEvents = pgTable(
  ...
  (table) => [
    index("calendar_events_client_idx").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("calendar_events_start_time_idx").using(
      "btree",
      table.startTime.asc().nullsLast().op("timestamp_ops"),
    ),
    index("calendar_events_task_idx").using(
      "btree",
      table.taskId.asc().nullsLast().op("uuid_ops"),
    ),
    index("calendar_events_tenant_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("calendar_events_type_idx").using(
      "btree",
...
export const clientContacts = pgTable(
  ...
  (table) => [
    index("idx_client_contact").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_primary_contact").using(
      "btree",
...
export const clientDirectors = pgTable(
  ...
  (table) => [
    index("idx_client_director").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_director_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    foreignKey({
...
export const clientPscs = pgTable(
  ...
  (table) => [
    index("idx_client_psc").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_psc_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    foreignKey({
...
export const clientPortalAccess = pgTable(
  ...
  (table) => [
    index("client_portal_access_client_idx").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("client_portal_access_tenant_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("client_portal_access_user_client_idx").using(
      "btree",
      table.portalUserId.asc().nullsLast().op("uuid_ops"),
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
...
export const clientPortalInvitations = pgTable(
  ...
  (table) => [
    index("client_portal_invitations_email_idx").using(
      "btree",
      table.email.asc().nullsLast().op("text_ops"),
    ),
    index("client_portal_invitations_status_idx").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("client_portal_invitations_tenant_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("client_portal_invitations_token_idx").using(
      "btree",
...
export const clientPortalSession = pgTable(
...
export const clientPortalAccount = pgTable(
...
export const clientPortalUsers = pgTable(
  ...
  (table) => [
    index("client_portal_users_email_idx").using(
      "btree",
      table.email.asc().nullsLast().op("text_ops"),
    ),
    index("client_portal_users_tenant_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const clientPortalVerification = pgTable(
...
export const clientTaskTemplateOverrides = pgTable(
  ...
  (table) => [
    uniqueIndex("client_task_template_overrides_client_template_unique").using(
      "btree",
      table.clientId.asc().nullsLast().op("text_ops"),
      table.templateId.asc().nullsLast().op("text_ops"),
    ),
    index("client_task_template_overrides_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const clientTransactionData = pgTable(
  ...
  (table) => [
    index("idx_transaction_data_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_transaction_data_lead").using(
      "btree",
      table.leadId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_transaction_data_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const compliance = pgTable(
  ...
  (table) => [
    index("idx_compliance_assignee").using(
      "btree",
      table.assignedToId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_compliance_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_compliance_due_date").using(
      "btree",
    ...
    index("idx_compliance_type").using(
      "btree",
      table.type.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const companiesHouseCache = pgTable(
  ...
  (table) => [
    uniqueIndex("companies_house_cache_company_number_idx").using(
      "btree",
      table.companyNumber.asc().nullsLast().op("text_ops"),
    ),
    index("companies_house_cache_expires_at_idx").using(
      "btree",
      table.expiresAt.asc().nullsLast().op("timestamp_ops"),
    ),
    unique("companies_house_cache_company_number_unique").on(
      table.companyNumber,
    ),
  ],
);
...
export const clientServices = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_client_service").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
...
export const emailQueue = pgTable(
  ...
  (table) => [
    index("email_queue_recipient_email_idx").using(
      "btree",
      table.recipientEmail.asc().nullsLast().op("text_ops"),
    ),
    index("email_queue_send_at_idx").using(
      "btree",
      table.sendAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("email_queue_status_idx").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("email_queue_template_id_idx").using(
      "btree",
      table.emailTemplateId.asc().nullsLast().op("text_ops"),
    ),
    index("email_queue_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const emailTemplates = pgTable(
  ...
  (table) => [
    index("email_templates_active_idx").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("email_templates_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("email_templates_type_idx").using(
      "btree",
      table.templateType.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenants.id],
...
export const feedback = pgTable(
  ...
  (table) => [
    ...
    index("idx_feedback_tenant_status").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.status.asc().nullsLast().op("text_ops"),
    ),
...
export const importLogs = pgTable(
  ...
  (table) => [
    index("import_logs_entity_type_idx").using(
      "btree",
      table.entityType.asc().nullsLast().op("enum_ops"),
    ),
    index("import_logs_imported_by_idx").using(
      "btree",
      table.importedBy.asc().nullsLast().op("text_ops"),
    ),
    index("import_logs_started_at_idx").using(
      "btree",
      table.startedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("import_logs_status_idx").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("import_logs_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const documents = pgTable(
  "documents",
  {
    ...
    signedPdfUrlExpiresAt: timestamp("signed_pdf_url_expires_at", {
      mode: "string",
    }),
  ...
  (table) => [
    index("idx_document_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_document_parent").using(
      "btree",
      table.parentId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_document_path").using(
      "btree",
      table.path.asc().nullsLast().op("text_ops"),
    ),
    index("idx_document_share_token").using(
      "btree",
      table.shareToken.asc().nullsLast().op("text_ops"),
    ),
    index("idx_document_task").using(
      "btree",
      table.taskId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const invoices = pgTable(
  ...
  (table) => [
    index("idx_invoice_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_invoice_due_date").using(
      "btree",
      table.dueDate.asc().nullsLast().op("date_ops"),
    ),
    index("idx_invoice_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_invoice_xero_id").using(
      "btree",
      table.xeroInvoiceId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_invoice_xero_sync_status").using(
      "btree",
      table.xeroSyncStatus.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("idx_tenant_invoice_number").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const kycVerifications = pgTable(
  ...
  (table) => [
    index("idx_kyc_verification_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_kyc_verification_lemverify_id").using(
      "btree",
      table.lemverifyId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_kyc_verification_session").using(
      "btree",
      table.onboardingSessionId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_kyc_verification_status").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("idx_kyc_verification_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const invitations = pgTable(
  ...
  (table) => [
    index("idx_invitation_email_tenant").using(
      "btree",
      table.email.asc().nullsLast().op("text_ops"),
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_invitation_status").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("idx_invitation_token").using(
      "btree",
      table.token.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const leaveBalances = pgTable(
  ...
  (table) => [
    index("idx_leave_balances_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("idx_leave_balances_user_year").using(
      "btree",
...
export const leaveRequests = pgTable(
  ...
  (table) => [
    index("idx_leave_requests_date_range").using(
      "btree",
      table.startDate.asc().nullsLast().op("date_ops"),
      table.endDate.asc().nullsLast().op("date_ops"),
    ),
    index("idx_leave_requests_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_leave_requests_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_leave_requests_user").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const legalPages = pgTable(
  ...
  (table) => [
    index("idx_legal_pages_tenant_type").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const messageThreads = pgTable(
  ...
  (table) => [
    index("message_threads_client_idx").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("message_threads_last_message_idx").using(
      "btree",
      table.lastMessageAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("message_threads_tenant_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("message_threads_type_idx").using(
      "btree",
      table.type.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const messages = pgTable(
  ...
  (table) => [
    ...
    index("messages_sender_idx").using(
      "btree",
      table.senderType.asc().nullsLast().op("text_ops"),
...
export const notifications = pgTable(
  ...
  (table) => [
    ...
    index("notifications_tenant_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("notifications_user_is_read_idx").using(
      "btree",
...
export const onboardingResponses = pgTable(
  ...
  (table) => [
    index("idx_onboarding_response_session").using(
      "btree",
      table.onboardingSessionId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_onboarding_response_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const leads = pgTable(
  "leads",
  {
    ...
    estimatedTurnover: numeric("estimated_turnover", {
      precision: 15,
      scale: 2,
    }),
  ...
  (table) => [
    index("idx_lead_assigned").using(
      "btree",
      table.assignedToId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_lead_created").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    ...
    index("idx_lead_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_lead_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const portalCategories = pgTable(
  ...
  (table) => [
    index("idx_portal_categories_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_portal_categories_sort").using(
      "btree",
      table.sortOrder.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_portal_categories_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const portalLinks = pgTable(
  ...
  (table) => [
    index("idx_portal_links_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_portal_links_category").using(
      "btree",
      table.categoryId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_portal_links_internal").using(
      "btree",
      table.isInternal.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_portal_links_sort").using(
      "btree",
      table.sortOrder.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_portal_links_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const pricingRules = pgTable(
  ...
  (table) => [
    index("idx_pricing_rule_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_pricing_rule_service").using(
      "btree",
      table.componentId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_pricing_rule_type").using(
      "btree",
...
export const proposalNotes = pgTable(
  ...
  (table) => [
    index("proposal_notes_proposal_id_idx").using(
      "btree",
      table.proposalId.asc().nullsLast().op("uuid_ops"),
    ),
    index("proposal_notes_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("proposal_notes_user_id_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const proposals = pgTable(
  ...
  (table) => [
    index("idx_proposal_assignee").using(
      "btree",
      table.assignedToId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_proposal_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_proposal_created").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("idx_proposal_lead").using(
      "btree",
      table.leadId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("idx_proposal_number").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.proposalNumber.asc().nullsLast().op("text_ops"),
    ),
    index("idx_proposal_sales_stage").using(
      "btree",
      table.salesStage.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_proposal_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_proposal_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const proposalSignatures = pgTable(
  ...
  (table) => [
    index("idx_signature_docuseal").using(
      "btree",
      table.docusealSubmissionId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_signature_proposal").using(
      "btree",
      table.proposalId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
    ...
    unique("proposal_signatures_docuseal_submission_id_unique").on(
...
export const proposalTemplates = pgTable(
  ...
  (table) => [
    index("idx_template_category").using(
      "btree",
      table.category.asc().nullsLast().op("text_ops"),
    ),
    index("idx_template_is_default").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.isDefault.asc().nullsLast().op("text_ops"),
    ),
    index("idx_template_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const proposalVersions = pgTable(
  ...
  (table) => [
    index("idx_proposal_version_created").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("idx_proposal_version_number").using(
      "btree",
      table.proposalId.asc().nullsLast().op("uuid_ops"),
      table.version.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_proposal_version_proposal").using(
      "btree",
      table.proposalId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const proposalServices = pgTable(
  ...
  (table) => [
    index("idx_proposal_service_code").using(
      "btree",
      table.componentCode.asc().nullsLast().op("text_ops"),
    ),
    index("idx_proposal_service_proposal").using(
      "btree",
      table.proposalId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const onboardingSessions = pgTable(
  ...
  (table) => [
    index("idx_onboarding_session_assigned").using(
      "btree",
      table.assignedToId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_onboarding_session_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_onboarding_session_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_onboarding_session_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const onboardingTasks = pgTable(
  ...
  (table) => [
    index("idx_onboarding_task_assigned").using(
      "btree",
      table.assignedToId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_onboarding_task_done").using(
      "btree",
      table.done.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_onboarding_task_sequence").using(
      "btree",
      table.sessionId.asc().nullsLast().op("uuid_ops"),
      table.sequence.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_onboarding_task_session").using(
      "btree",
      table.sessionId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const taskTemplates = pgTable(
  ...
  (table) => [
    index("task_templates_active_idx").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("task_templates_service_id_idx").using(
      "btree",
      table.serviceId.asc().nullsLast().op("uuid_ops"),
    ),
    index("task_templates_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const staffCapacity = pgTable(
  ...
  (table) => [
    index("idx_staff_capacity_effective_from").using(
      "btree",
      table.effectiveFrom.asc().nullsLast().op("date_ops"),
    ),
    index("idx_staff_capacity_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_staff_capacity_user").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const taskAssignmentHistory = pgTable(
  ...
  (table) => [
    index("task_assignment_history_changed_at_idx").using(
      "btree",
      table.changedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("task_assignment_history_task_id_idx").using(
      "btree",
      table.taskId.asc().nullsLast().op("uuid_ops"),
    ),
    index("task_assignment_history_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const taskNotes = pgTable(
  ...
  (table) => [
    index("task_notes_task_id_idx").using(
      "btree",
      table.taskId.asc().nullsLast().op("uuid_ops"),
    ),
    index("task_notes_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("task_notes_user_id_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const taskWorkflowInstances = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_task_workflow_instance").using(
      "btree",
      table.taskId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflow_instance").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflow_instance_status").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("idx_workflow_instance_version").using(
      "btree",
...
export const rolePermissions = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_role_module").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const services = pgTable(
  ...
  (table) => [
    index("idx_service_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_service_category").using(
      "btree",
      table.category.asc().nullsLast().op("enum_ops"),
    ),
    uniqueIndex("idx_service_code").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const tasks = pgTable(
  ...
  (table) => [
    ...
    index("idx_task_auto_generated").using(
      "btree",
      table.autoGenerated.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_task_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    ...
    index("idx_task_preparer").using(
      "btree",
      table.preparerId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_task_progress").using(
      "btree",
      table.progress.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_task_reviewer").using(
      "btree",
      table.reviewerId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_task_service").using(
      "btree",
      table.serviceId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_task_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_task_template").using(
      "btree",
      table.templateId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const toilAccrualHistory = pgTable(
  "toil_accrual_history",
  {
    ...
    accrualDate: timestamp("accrual_date", { mode: "string" })
      .defaultNow()
      .notNull(),
  ...
  (table) => [
    index("idx_toil_accrual_expiry").using(
      "btree",
      table.expiryDate.asc().nullsLast().op("date_ops"),
    ),
    index("idx_toil_accrual_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_toil_accrual_user").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_toil_accrual_week_ending").using(
      "btree",
      table.weekEnding.asc().nullsLast().op("date_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenants.id],
...
export const userFavorites = pgTable(
  ...
  (table) => [
    index("idx_user_favorites_link").using(
      "btree",
      table.linkId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_user_favorites_user").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("idx_user_link_favorite").using(
      "btree",
...
export const userPermissions = pgTable(
  ...
  (table) => [
    index("idx_permissions_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("idx_user_module").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
      table.module.asc().nullsLast().op("text_ops"),
    ),
...
export const userSettings = pgTable(
  "user_settings",
  {
    ...
    notifDeadlineApproaching: boolean("notif_deadline_approaching").default(
      true,
    ),
...
export const workTypes = pgTable(
  ...
  (table) => [
    index("idx_work_type_sort_order").using(
      "btree",
      table.sortOrder.asc().nullsLast().op("int4_ops"),
    ),
    uniqueIndex("idx_work_type_tenant_code").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.code.asc().nullsLast().op("text_ops"),
    ),
...
export const timeEntries = pgTable(
  ...
  (table) => [
    index("idx_time_entry_billable").using(
      "btree",
      table.billable.asc().nullsLast().op("bool_ops"),
      table.billed.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_time_entry_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_time_entry_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_time_entry_task").using(
      "btree",
      table.taskId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_time_entry_user_date").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
      table.date.asc().nullsLast().op("text_ops"),
    ),
    index("idx_time_entry_work_type").using(
      "btree",
      table.workType.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenants.id],
...
export const workflowEmailRules = pgTable(
  ...
  (table) => [
    index("workflow_email_rules_stage_id_idx").using(
      "btree",
      table.stageId.asc().nullsLast().op("uuid_ops"),
    ),
    index("workflow_email_rules_template_id_idx").using(
      "btree",
      table.emailTemplateId.asc().nullsLast().op("text_ops"),
    ),
    index("workflow_email_rules_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("workflow_email_rules_workflow_id_idx").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const users: any = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_tenant_email").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.email.asc().nullsLast().op("text_ops"),
    ),
...
export const timesheetSubmissions = pgTable(
  ...
  (table) => [
    index("timesheet_submissions_reviewer_idx").using(
      "btree",
      table.reviewedBy.asc().nullsLast().op("text_ops"),
    ),
    index("timesheet_submissions_status_idx").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("timesheet_submissions_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("timesheet_submissions_user_week_unique").using(
      "btree",
      table.userId.asc().nullsLast().op("date_ops"),
      table.weekStartDate.asc().nullsLast().op("text_ops"),
    ),
    index("timesheet_submissions_week_date_idx").using(
      "btree",
      table.weekStartDate.asc().nullsLast().op("date_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenants.id],
...
export const workflowStages = pgTable(
  ...
  (table) => [
    index("idx_stage_order").using(
      "btree",
      table.workflowId.asc().nullsLast().op("int4_ops"),
      table.stageOrder.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_stage_workflow").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const clients = pgTable(
  ...
  (table) => [
    index("idx_client_manager").using(
      "btree",
      table.accountManagerId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_client_name").using(
      "btree",
      table.name.asc().nullsLast().op("text_ops"),
    ),
    index("idx_client_status").using(
      "btree",
      table.status.asc().nullsLast().op("enum_ops"),
    ),
    index("idx_client_xero_contact_id").using(
      "btree",
      table.xeroContactId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_client_xero_sync_status").using(
      "btree",
      table.xeroSyncStatus.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("idx_tenant_client_code").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.clientCode.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenants.id],
...
export const calendarEventAttendees = pgTable(
  ...
  (table) => [
    uniqueIndex("calendar_event_attendees_event_user_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("uuid_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    index("calendar_event_attendees_status_idx").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("calendar_event_attendees_user_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const documentSignatures = pgTable(
  ...
  (table) => [
    index("idx_document_signature_document").using(
      "btree",
      table.documentId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_document_signature_submission").using(
      "btree",
      table.docusealSubmissionId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
    ...
    unique("document_signatures_docuseal_submission_id_unique").on(
      table.docusealSubmissionId,
    ),
  ],
);
...
export const integrationSettings = pgTable(
  ...
  (table) => [
    index("integration_settings_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("integration_settings_tenant_type_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.integrationType.asc().nullsLast().op("text_ops"),
    ),
    index("integration_settings_type_idx").using(
      "btree",
      table.integrationType.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const invoiceItems = pgTable(
  ...
  (table) => [
    index("idx_invoice_item_invoice").using(
      "btree",
...
export const messageThreadParticipants = pgTable(
  ...
  (table) => [
    index("message_thread_participants_participant_idx").using(
      "btree",
      table.participantType.asc().nullsLast().op("text_ops"),
      table.participantId.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("message_thread_participants_thread_participant_idx").using(
      "btree",
      table.threadId.asc().nullsLast().op("text_ops"),
      table.participantType.asc().nullsLast().op("uuid_ops"),
      table.participantId.asc().nullsLast().op("uuid_ops"),
    ),
    index("message_thread_participants_user_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const workflows = pgTable(
  ...
  (table) => [
    index("idx_workflow_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_workflow_service").using(
      "btree",
      table.serviceId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflow_type").using(
      "btree",
      table.type.asc().nullsLast().op("text_ops"),
    ),
    index("idx_workflow_version").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
      table.version.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenants.id],
...
export const workflowVersions = pgTable(
  ...
  (table) => [
    index("idx_workflow_version_active").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
      table.isActive.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflow_version_created").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    uniqueIndex("idx_workflow_version_number").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
      table.version.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflow_version_workflow").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const workflowTemplates = pgTable(
  ...
  (table) => [
    index("workflow_templates_template_id_idx").using(
      "btree",
      table.templateId.asc().nullsLast().op("text_ops"),
    ),
    index("workflow_templates_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("workflow_templates_trigger_type_idx").using(
      "btree",
      table.triggerType.asc().nullsLast().op("text_ops"),
    ),
    index("workflow_templates_workflow_id_idx").using(
      "btree",
      table.workflowId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const workingPatterns = pgTable(
  ...
  (table) => [
    index("idx_working_patterns_effective_from").using(
      "btree",
      table.effectiveFrom.asc().nullsLast().op("date_ops"),
    ),
    index("idx_working_patterns_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_working_patterns_user").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const xeroConnections = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_xero_client").using(
      "btree",
      table.clientId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_xero_tenant").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const xeroWebhookEvents = pgTable(
  ...
  (table) => [
    index("xero_webhook_events_created_at_idx").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("xero_webhook_events_event_category_idx").using(
      "btree",
      table.eventCategory.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("xero_webhook_events_event_id_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("text_ops"),
    ),
    index("xero_webhook_events_event_type_idx").using(
      "btree",
      table.eventType.asc().nullsLast().op("text_ops"),
    ),
    index("xero_webhook_events_processed_idx").using(
      "btree",
      table.processed.asc().nullsLast().op("bool_ops"),
    ),
    index("xero_webhook_events_tenant_id_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
