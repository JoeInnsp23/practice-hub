...
export function LeaveRequestApprovedEmail({
  userName,
  leaveType,
  startDate,
  endDate,
  ...
  return (
    <Html>
      <Head />
      <Preview>Your leave request has been approved</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={approvedBanner}>
            <Text style={approvedText}>
              Your leave has been confirmed and added to the team calendar.
            </Text>
          </Section>
...
export default LeaveRequestApprovedEmail;
