...
export default function OnboardingPendingPage() {
  ...
  const reVerificationMutation =
    trpc.onboarding.requestReVerification.useMutation();
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-200 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="p-6 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground">
                {isApproved &&
                  "Your identity has been verified. Redirecting to portal..."}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Your previous verification was declined. If you believe this
                  was an error or have new/corrected documents, you can request
                  a new verification.
                </p>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-900 rounded-lg p-3 mb-4">
                  <div className="flex items-start gap-2 text-sm text-yellow-800 dark:text-yellow-200">
                    ...
                    <p>
                      <strong>Please note:</strong> Make sure you have valid,
                      unaltered identity documents before requesting a new
                      verification. Repeated failed verifications may result in
                      additional review.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  ...
                  through our secure partner, LEM Verify. This process includes:
                </p>

                <ul className="text-sm text-muted-foreground space-y-1 mb-4 ml-4">
                  <li>
                    • Upload identity documents (passport or driving license)
                  </li>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-900 rounded-lg p-3 mb-4">
                  <div className="flex items-start gap-2 text-sm text-yellow-800 dark:text-yellow-200">
                    <AlertCircle className="h-4 w-4 flex-shrink-0 mt-0.5" />
                    <p>
                      <strong>Please note:</strong> You may need to upload your
                      identity documents again on the verification platform.
                      This is required for biometric verification and compliance
                      checks.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-xs text-muted-foreground mt-3">
                  Verification typically takes 2-5 minutes. Results are usually
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-medium ${
                    kycVerification.documentVerified
                      ? "text-green-600"
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-medium ${
                    kycVerification.facematchResult === "pass"
                      ? "text-green-600"
                      : "text-muted-foreground"
                  }`}
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-medium ${
                    kycVerification.livenessResult === "pass"
                      ? "text-green-600"
                      : "text-muted-foreground"
                  }`}
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-medium ${
                    kycVerification.amlStatus === "clear"
                      ? "text-green-600"
                      : kycVerification.amlStatus
                        ? "text-yellow-600"
                        : "text-muted-foreground"
                  }`}
                >
        ...
        <Card className="p-6 mt-6 bg-muted/50">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            If you're experiencing issues with verification or have questions,
