          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              ...
              <p className="font-medium">
                Upload: Passport, Driving License, Proof of Address, Company
                Docs
              </p>
            </div>
          </div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      {file.documentType !== "unknown" && (
                        <span className="text-xs text-muted-foreground">
                          {file.documentType === "individual_id" &&
                            "ID Document"}
                          {file.documentType === "company_certificate" &&
                            "Company Doc"}
                          {file.documentType === "address_proof" &&
                            "Proof of Address"}
                        </span>
                      )}
          ...
          <div className="mt-4 p-3 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-900 rounded">
            <div className="flex items-start gap-2 text-sm text-yellow-800 dark:text-yellow-200">
              ...
              <p>
                ...
                Please review and verify the pre-filled fields in the next
                steps.
              </p>
            </div>
          </div>
