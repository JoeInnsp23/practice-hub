...
export default function AcceptInvitationPage({
  ...
  useEffect(() => {
    const verifyToken = async () => {
      try {
        const response = await fetch(`/api/portal/verify-invitation?token=${params.token}`);
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p className="text-center text-sm text-muted-foreground mb-4">
              Please contact your account manager for assistance or request a new invitation.
            </p>
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle className="text-center text-2xl">Welcome to the Client Portal!</CardTitle>
            <CardDescription className="text-center">
