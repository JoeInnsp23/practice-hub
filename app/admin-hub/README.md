...
|-------|---------|--------------|----------------|
| `departments` | [Auto-detected] | ✅ tenantId | See schema |
| `users` | [Auto-detected] | ✅ tenantId | See schema |
| `userSettings` | [Auto-detected] | ✅ tenantId | See schema |
| `staffCapacity` | [Auto-detected] | ✅ tenantId | See schema |
| `invitations` | [Auto-detected] | ✅ tenantId | See schema |
| `feedback` | [Auto-detected] | ✅ tenantId | See schema |
| `kycVerifications` | [Auto-detected] | ✅ tenantId | See schema |
| `userPermissions` | [Auto-detected] | ✅ tenantId | See schema |
| `portalCategories` | [Auto-detected] | ✅ tenantId | See schema |
| `portalLinks` | [Auto-detected] | ✅ tenantId | See schema |
| `userFavorites` | [Auto-detected] | ✅ tenantId | See schema |
...
| `companiesHouseRateLimit` | [Auto-detected] | ✅ tenantId | See schema ||-------|
