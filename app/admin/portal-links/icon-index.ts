...
class IconIndex {
  ...
  private iconComponents: Map<string, LucideIcon> = new Map();
  ...
  private readonly aliases: Record<string, string[]> = {
    FileText: ["document", "paper", "page", "doc", "text", "note", "article", "report"],
    ...
    Building2: ["company", "office", "building", "corporate", "business", "enterprise"],
    Building: ["company", "office", "building", "structure", "premises"],
    Users: ["people", "users", "team", "group", "members", "staff", "employees"],
    ...
    MessageSquare: ["chat", "message", "comment", "discussion", "conversation", "talk"],
    ...
    Settings: ["config", "settings", "options", "preferences", "gear", "cog", "configure"],
    ...
    CreditCard: ["payment", "card", "credit", "debit", "pay", "visa", "mastercard"],
    ...
    ShoppingCart: ["cart", "shop", "shopping", "basket", "purchase", "buy", "ecommerce"],
    ...
    AlertCircle: ["warning", "alert", "attention", "important", "info", "notice"],
...
export const getIconComponent = (name: string) => iconIndex.getIconComponent(name);
export const searchIcons = (query: string, limit?: number) => iconIndex.search(query, limit);
