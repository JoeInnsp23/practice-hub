...
export default function AdminKYCDetailPage({ params }: { params: { id: string } }) {
  ...
  const { data: verification, isLoading, refetch } = trpc.adminKyc.getVerificationDetail.useQuery({
  ...
  const getScoreBadge = (score?: string | null) => {
    ...
    if (numScore >= 90) {
      return <Badge className="bg-green-100 text-green-800">High: {numScore}%</Badge>;
    } else if (numScore >= 70) {
      return <Badge className="bg-yellow-100 text-yellow-800">Medium: {numScore}%</Badge>;
    } else {
      return <Badge className="bg-red-100 text-red-800">Low: {numScore}%</Badge>;
    }
  };
  ...
  if (!verification) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px]">
        ...
        <p className="text-muted-foreground mb-4">The requested verification could not be found.</p>
  ...
  const isApproved = verification.approvedAt !== null && !verification.rejectionReason;
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p className="font-medium">{verification.clientPhone || "N/A"}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <Badge variant={verification.clientStatus === "active" ? "default" : "secondary"}>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <Badge
                  variant={
                    verification.outcome === "pass" ? "default" : verification.outcome === "fail" ? "destructive" : "secondary"
                  }
                >
              ...
              {verification.completedAt && (
                <div>
                  ...
                  <p className="text-sm">
                    {formatDistanceToNow(new Date(verification.completedAt), { addSuffix: true })}
                  </p>
                </div>
              )}
            </CardContent>
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="font-medium">
                    {verification.approverFirstName} {verification.approverLastName}
                  </p>
                </div>
                {verification.approvedAt && (
                  <div>
                    ...
                    <p className="text-sm">
                      {formatDistanceToNow(new Date(verification.approvedAt), { addSuffix: true })}
                    </p>
                  </div>
                )}
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="capitalize">{verification.documentType?.replace("_", " ") || "N/A"}</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Badge
                  variant={verification.facematchResult === "pass" ? "default" : "destructive"}
                >
              ...
              <div>
                ...
                <Badge
                  variant={verification.livenessResult === "pass" ? "default" : "destructive"}
                >
          ...
          <Card className={
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  variant={
                    verification.amlStatus === "clear" ? "default" :
                    verification.amlStatus === "match" || verification.amlStatus === "pep" ? "destructive" :
                    "secondary"
                  }
                >
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                ...
                <div className="p-3 border rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">Sanctions Match</p>
                ...
                <div className="p-3 border rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">Watchlist Match</p>
                ...
                <div className="p-3 border rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">Adverse Media</p>
          ...
          {(verification.reportUrl || verification.documentsUrl) && (
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                {verification.documentsUrl && Array.isArray(verification.documentsUrl) && (
                  <div className="space-y-1">
                    <p className="text-sm font-medium">Uploaded Documents:</p>
                    {(verification.documentsUrl as string[]).map((url, index) => (
                      <a
                        key={index}
                        href={url}
                        target="_blank"
      ...
      <AlertDialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to approve this verification? This will activate the client's
              portal access.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Please provide a detailed reason for rejecting this verification. This will be logged
