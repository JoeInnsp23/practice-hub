...
|-------|---------|--------------|----------------|
| `clients` | [Auto-detected] | ✅ tenantId | See schema |
| `clientContacts` | [Auto-detected] | ✅ tenantId | See schema |
| `clientDirectors` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPSCs` | [Auto-detected] | ✅ tenantId | See schema |
| `services` | [Auto-detected] | ✅ tenantId | See schema |
| `clientServices` | [Auto-detected] | ✅ tenantId | See schema |
| `clientTaskTemplateOverrides` | [Auto-detected] | ✅ tenantId | See schema |
| `documents` | [Auto-detected] | ✅ tenantId | See schema |
| `documentSignatures` | [Auto-detected] | ✅ tenantId | See schema |
| `compliance` | [Auto-detected] | ✅ tenantId | See schema |
| `proposalServices` | [Auto-detected] | ✅ tenantId | See schema |
| `clientTransactionData` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPortalUsers` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPortalAccess` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPortalInvitations` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPortalSessions` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPortalAccounts` | [Auto-detected] | ✅ tenantId | See schema |
| `clientPortalVerifications` | [Auto-detected] | ✅ tenantId | See schema ||-------|
...
| `import-logs.ts` | [Auto-detected] | See file |
...
| `/client-hub/` | [Auto-detected] | Member |
| `/client-hub/clients` | [Auto-detected] | Member |
| `/client-hub/clients/[id]` | [Auto-detected] | Member |
| `/client-hub/compliance` | [Auto-detected] | Member |
| `/client-hub/documents` | [Auto-detected] | Member |
| `/client-hub/invoices` | [Auto-detected] | Member |
| `/client-hub/invoices/[id]` | [Auto-detected] | Member |
| `/client-hub/leave` | [Auto-detected] | Member |
| `/client-hub/leave/calendar` | [Auto-detected] | Member |
| `/client-hub/reports` | [Auto-detected] | Member |
| `/client-hub/services` | [Auto-detected] | Member |
| `/client-hub/settings` | [Auto-detected] | Member |
| `/client-hub/settings/task-templates` | [Auto-detected] | Member |
| `/client-hub/tasks` | [Auto-detected] | Member |
| `/client-hub/tasks/[id]` | [Auto-detected] | Member |
| `/client-hub/time` | [Auto-detected] | Member |
| `/client-hub/time-tracking` | [Auto-detected] | Member |
| `/client-hub/time/approvals` | [Auto-detected] | Member |
| `/client-hub/workflows` | [Auto-detected] | Member ||-------------|--------------|
