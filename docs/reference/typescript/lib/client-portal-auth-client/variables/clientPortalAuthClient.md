...
[practice-hub](../../../README.md) / [lib/client-portal-auth-client](../README.md) / clientPortalAuthClient

# Variable: clientPortalAuthClient
...
Defined in: [lib/client-portal-auth-client.ts:7](https://github.com/JoeInnsp23/practice-hub/blob/c04a58b0b0fade7601286d40714502e52afe6cf4/lib/client-portal-auth-client.ts#L7)
...
...\[`Prettify`\<`InferUserUpdateCtx`\<\{ `basePath`: `string`; `baseURL`: `string`; \}, `FetchOptions`\>\>?, `FetchOptions`?\]
